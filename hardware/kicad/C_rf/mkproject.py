...
SHEETS = [
    ("01_power",     "Guc",             "VIN_PROT -> +5V buck (role bobinleri), +3V3 A kartindan"),
    ("02_protect",   "Koruma + T/R",    "gaz desarj + TVS + limitleyici + T/R rolesi, x4 kanal"),
    ("03_filter",    "Filtre bankasi",  "7 pozisyon x 4 kanal, G6KU kilitlenen role"),
    ("04_atten",     "Zayiflaticilar",  "PE4312 x4, ortak seri hat, ayri LE"),
    ("05_driver",    "Role surucu",     "TPIC6B595 x8, 64 acik drenaj cikis, set/reset"),
    ("06_iface",     "Kart arasi",      "A kartina baslik + koaks kuyruk"),
]
...
def root():
    ...
    parts = [
        ...
        '    (comment 2 "Baglantilar kicad/NETLIST_C.md sartnamesinden")',
        '  )',
        '  (lib_symbols)',
    ]
